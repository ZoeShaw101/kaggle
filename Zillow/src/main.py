...
if __name__ == '__main__':
    ...
    # ## single model
    # InputDir = '%s/p3' % DataDir
    # OutputDir = '%s/SingleModel3' % DataDir
    # strategies = ['rf']
    # SingleModel.run(strategies,InputDir,OutputDir)

    ## ensemble model
    InputDir = '%s/SingleModel3' % DataDir
    OutputDir = '%s/EnsembleModel3' % DataDir

    ## evaluation ensemble model
    em = EnsembleModel('%s/p3' % DataDir,OutputDir)
